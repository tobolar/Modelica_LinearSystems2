...
Generate release notes from closed GitHub issues:
...
def main(dir, milestone, version, auth):
    owner = 'modelica'
    repo = 'Modelica_LinearSystems2'
    shortName = 'M_LS2'
    html_template = 'MLS2-ReleaseNotes-Template.html'

...
<h4>Syntax</h4>
<blockquote><pre>
result = DiscreteZerosAndPoles.Analysis.<strong>denominatorDegree</strong>(dzp)
</pre></blockquote>

<h4>Description</h4>
<p>
Function Analysis.<strong>denominatorDegree</strong> calculates the degree of the denominator polynomial constituted by the first and second order polynomials of the DiscreteZeroAndPoles numerator.
</p>
...
<p>
from a ZerosAndPoles record represented by first and second order numerator
and denominator polynomials. The poles and zeros and the gain <tt>k</tt> are computed
(<a href=\"modelica://Modelica_LinearSystems2.ZerosAndPoles.Analysis.zerosAndPoles\">zerosAndPoles</a>)
and are used as inputs in the TransferFunction constructor.
</p>
...
<h4>Syntax</h4>
<blockquote><pre>
ss = ZerosAndPoles.Conversion.<strong>toStateSpace</strong>(zp)
</pre></blockquote>
...
<h4>Description</h4>
<p>
Generate a&nbsp;matrix of ZerosAndPoles data records by linearization of a model defined by
modelName. The linearization is performed at time T_linearize of the simulation. The system
...
<h4>Description</h4>
<p>
Reads and loads a&nbsp;zeros-and-poles transfer function from a&nbsp;mat-file <code>fileName</code>.

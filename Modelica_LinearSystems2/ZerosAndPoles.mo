...
<h4>Description</h4>
<p>
Function <strong>impulseResponse</strong> calculates the time response of a ZerosAndPoles transfer function with impulse input.
The system is first transformed zo a state space system, which is transformed to a appropriate discrete state space system and, starting at <strong>x</strong>(t=0)=<strong>0</strong> and <strong>y</strong>(t=0)=<strong>C</strong>*<strong>x</strong>0 + <strong>D</strong>*<strong>u</strong>0, the outputs <strong>y</strong> and <strong>x</strong> are calculated for each time step t=k*dt.
</p>
<blockquote><pre>
...
<h4>Description</h4>
<p>
Function <strong>rampResponse</strong> calculates the time response of a transfer function for ramp input u = t.
The state space system is transformed to a appropriate discrete state space system and, starting at <strong>x</strong>(t=0)=<strong>0</strong> and <strong>y</strong>(t=0)=<strong>C</strong>*<strong>x</strong>0 + <strong>D</strong>*<strong>u</strong>0, the outputs <strong>y</strong> and <strong>x</strong> are calculated for each time step t=k*dt.
</p>
<blockquote><pre>
...
// eigenvalues = {-0.5 + j*sqrt(3)/2, -0.5 - j*sqrt(3)/2}
    ...
    encapsulated function eigenVectors
      "Calculate the right eigenvectors of the corresponding state space system of a zeros-and-poles transfer function and write them columnwise in a matrix"
      import Modelica_LinearSystems2.StateSpace;
      import Modelica_LinearSystems2.ZerosAndPoles;
      import Complex;
...
the simulation. The system is generated by using <a href=\"modelica://Modelica_LinearSystems2.StateSpace.Import.fromFile\">StateSpace.Import.fromModel</a>
...
Therefore, it is assumed that the used array names are \"z\" and \"p\" or \"n1, n2, d1\" and \"d2\" respectively.
</p>
</html>"));
    ...
    encapsulated function filter
      ...
      input Types.AnalogFilter analogFilter=Types.AnalogFilter.CriticalDamping "Analog filter characteristics (CriticalDamping/Bessel/Butterworth/Chebyshev)";
      input Types.FilterType filterType=Types.FilterType.LowPass "Type of filter (LowPass/HighPass)";
      input Integer order(min=1) = 2 "Order of filter";
      input Modelica.Units.SI.Frequency f_cut=1/(2*Modelica.Constants.pi)
        "Cut-off frequency (default is w_cut = 1 rad/s)";
      input Real gain=1.0
